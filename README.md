...
> **Note:** This fork includes a Nix flake for easy installation and automatic upstream synchronization. See [FLAKE_USAGE.md](./FLAKE_USAGE.md) and [.github/UPSTREAM_SYNC.md](./.github/UPSTREAM_SYNC.md) for details.
